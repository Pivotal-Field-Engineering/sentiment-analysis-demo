...
public class SentimentApplication {
  ...
  private static Logger LOG = Logger.getLogger(SentimentApplication.class.getName());
  ...
  public CommandLineRunner intialiseRedisTemplate(RedisTemplate redisTemplate) {
    return (args) -> {
      redisTemplate.setValueSerializer(new Jackson2JsonRedisSerializer<Tweet>(Tweet.class));
